...
<section id="bot">
    <?php 
                        ...
                        <section id="modal">
                            <a href="admin.php" id="cerr"><i class="fa fa-times-circle-o"  aria-hidden="true"></i></a>
 ...
 ?>
     ...
     <section id="centro">
         <div id="folio">
    <?php echo "<a class='btn btn-warning' href='folionuevo.php?Id_reporte=".$row['Id_reporte']." ' >Agregar Folio Relacional</a> "; ?> </div>
    <br>
    <label><span>Reporte:</span>&nbsp;&nbsp;<?php  echo "REP".$numeroConCeros; ?></label>
