...
<body>
    ...
    <!-- Start Welcome area -->
<section id="centrar"><br>
<h1>Clientes</h1>
    <div id="contenedor" class="table-responsive col-sm-12">
        <a href="Clientesinto.php" id="agregar"" class="btn btn-success"> Agregar Cliente</a><br><br>
    
 <table id="myTable" class="table table-bordered table-hover" cellspacing="0" border="2"width="100%" >
    <thead>
         <tr>
        <td>Folio Cliente</td>
        <td>Empresa</td>
