...
<section id="bot">
    ...
    <div id="contenedor" class="table-responsive col-sm-12">
    <h2>Recientes</h2>
 <table  id="myTable" class="table table-bordered table-hover" style=" width:'100%'; " >
    ...
    <thead>
         <tr>
        <td>Folio Cliente</td>
        <td><div style="  overflow:hidden;">Empresa</div></td>
        <td>Num economico</td>
        <td><div style="  overflow:hidden;">Persona que reporta</div></td>
        <td>fecha</td>
        <td width="200"><div style="  overflow:hidden;">Descripción</div></td>
        <td>Folio Relación</td>
     </tr>  
    </thead>
...
$numeroConCeros = str_pad($mostrar['Id_reporte'], 6, "0", STR_PAD_LEFT);
     ...
     <td id="uni"><?php echo "<a  class='btn btn-info' href='ver.php?Id_reporte=".$mostrar['Id_reporte']."' >ver</a> "; ?></td>
     </tr><?php  
        } } ?>
</tbody>
